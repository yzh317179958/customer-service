...
在回复中可以嵌入产品图片，提升用户体验。使用 Markdown 图片格式：
...
| C11 (非 Pro) | `![C11](https://ai.fiido.com/assets/products/c11-electric-commute_thumb.webp)` |
| C21 | `![C21](https://ai.fiido.com/assets/products/c21-lightweight-step_thumb.webp)` |
| D3 Pro | `![D3 Pro](https://ai.fiido.com/assets/products/d3-pro-mini_thumb.webp)` |
| L3 | `![L3](https://ai.fiido.com/assets/products/l3-long-range_thumb.webp)` |
| M1 Pro | `![M1 Pro](https://ai.fiido.com/assets/products/m1-pro-fat-tire_thumb.webp)` |
| Nomads | `![Nomads](https://ai.fiido.com/assets/products/nomads-trekking_thumb.webp)` |
| T1 | `![T1](https://ai.fiido.com/assets/products/t1_thumb.webp)` |
| T2 | `![T2](https://ai.fiido.com/assets/products/t2-longtail-cargo-fo_thumb.webp)` |
| Air | `![Air](https://ai.fiido.com/assets/products/air-carbon-fiber_thumb.webp)` |

### 使用规则

1. **商品清单中嵌入图片**：在已发货/待发货商品前显示小图
2. **只对电动自行车嵌入图片**：配件（如 Pannier Bag、Worry-Free Purchase）不需要图片
3. **图片位置**：放在商品名称前面或上方
4. **可选使用**：如果觉得图片会让回复过长，可以省略

### 示例

```
✅ **已发货商品：**
![Titan](https://ai.fiido.com/assets/products/titan-robust-cargo-w_thumb.webp)
• Titan Fat Tire Touring Ebike - Long range × 1

⏳ **待发货商品：**
• Bike Rack Pannier Bag × 1 - 即将发货
```
