...
|:--------|:---:|------:|:------:|
[遍历 line_items，对每个商品:]
| [如果 image_url 存在:]![](image_url)<br>[结束如果]**[title]** | [quantity] | £[price] | [根据 fulfillment_status 显示: **Shipped** / Pending] |
...
|:-----|:----:|-----:|:------:|
[遍历 line_items，对每个商品:]
| [如果 image_url 存在:]![](image_url)<br>[结束如果]**[title]** | [quantity] | £[price] | [根据 fulfillment_status 显示: **已发货** / 待发货] |
...
| 商品 | 数量 | 价格 | 状态 |
|:-----|:----:|-----:|:------:|
| ![](image_url)<br>**Titan Fat Tire Touring Ebike** | 1 | £1,499.00 | **已发货** |
| ![](image_url)<br>**Bike Rack Pannier Bag** | 1 | £49.00 | **已发货** |
| **Worry-Free Purchase** | 1 | £99.00 | **已发货** |
...
|:-----|:----:|-----:|:------:|
| ![](image_url)<br>**Titan Fat Tire Touring Ebike** | 1 | £1,499.00 | **已发货** |
| ![](image_url)<br>**Bike Rack Pannier Bag** | 1 | £49.00 | 待发货 |
| **Worry-Free Purchase** | 1 | £99.00 | **已发货** |
...
| 商品 | 数量 | 价格 | 状态 |
|:-----|:----:|-----:|:------:|
| ![](image_url)<br>**Titan Fat Tire Touring Ebike** | 1 | £1,499.00 | 待发货 |
| ![](image_url)<br>**Bike Rack Pannier Bag** | 1 | £49.00 | 待发货 |
| **Worry-Free Purchase** | 1 | £99.00 | 待发货 |
...
### 排版说明
- **订单商品表格**：显示图片（如有）+ 名称、数量、价格、状态
- **状态列**：**已发货**（加粗） / 待发货（普通），直接在表格中显示，无需单独列出
- **服务类商品**：如「Worry-Free Purchase」为保障服务，状态显示为已发货但添加注释说明
- **无图片商品**：直接显示商品名称
- **价格右对齐**：使用 `-----:` 让价格列右对齐
- **状态居中**：使用 `:------:` 让状态列居中
...
9. **Icon使用规范** - 只使用以下icon，保持专业简洁：
   ...
   - 📧 邮箱联系方式
   - 📞 电话联系方式
   - **注意**：状态列不使用icon，已发货用加粗文字显示，待发货用普通文字
