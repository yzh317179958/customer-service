...
- `progress.md`（了解之前完成的工作）
- `architecture.md`（了解当前架构）
- `cross-module-refs.md` （了解之前跨模块完成的工作）
...
2️⃣ 查看 progress.md 以及 cross-module-refs.md 了解之前完成的工作
3️⃣ 执行实现计划的 Step [N]
