...
const Settings: React.FC = () => {
  ...
  const sections = [
    ...
    { title: '账号与合规', icon: Shield, desc: '修改密码、动态令牌验证及系统操作审计' },
    { title: '话术短语库', icon: Keyboard, desc: '管理个人及团队共享的快捷回复模版' },
    { title: '语言与时区', icon: Globe, desc: '切换后台语言（默认中文）及各地区时区显示' },
    { title: '外部集成', icon: Database, desc: '绑定 ERP 系统、物流 API 及售后备件库' },
  ];
